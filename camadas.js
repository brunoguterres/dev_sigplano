...
var ottobacias = new ol.layer.Tile({
    title: 'Ottobacias',
    legendUrl: url_geoserver+'?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=prh_rpb:ottobacias',
    source: new ol.source.TileWMS({
        url: url_geoserver,
